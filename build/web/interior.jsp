...
<html>
    <head>
        ...
        <title>Interior Designing Page</title>
        <style>
            html,body{  
                margin: 0;
                padding: 0;
  ...
  background-color: #717171;
    ...
    <body>
        ...
        <div class="slideshow-container">
            <b><h1> <u>Decor and Interior designing</u></h1></b>
<div class="mySlides fade">
  <img src="img/int1.jpg" style="width:80%;">

</div>

<div class="mySlides fade">

  <img src="img/int2.jpeg" style="width:80%;">
</div>

<div class="mySlides fade">

  <img src="img/int3.jpg" style="width:80%">
</div>
...
<div id="contact"><br><br>
    ...
    <table align="center">
        <tr>
            ...
            <td><a href="https://instagram.com/arquicreativa" target="null"><img src="img/instagram.png"alt="avatar"></a></td>
...
<!-----------------------------booking----------------------------->
<section id="booking">
    <h3><u>DECOR AND INTERIOR DESIGNING PLANS</u></h3><br><hr>
    <div class="promos">  
        <div class="promo">
            <div class="deal">
                <span>Basic</span>
