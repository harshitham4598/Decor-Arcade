  ...
  background-color: #717171;
    ...
    <body>
        ...
        <div class="slideshow-container">
            <b><h1> <u>Wall Painting</u></h1></b>
<div class="mySlides fade">
  <img src="img/wall1.jpg" style="width:80%;">

</div>

<div class="mySlides fade">

  <img src="img/wall2.jpg" style="width:80%;">
</div>

<div class="mySlides fade">

  <img src="img/wall3.jpg" style="width:80%">
</div>
...
<div id="contact"><br><br>
    ...
    <table align="center">
        <tr>
            ...
            <td><a href="https://instagram.com/wall_painting_decor" target="null"><img src="img/instagram.png"alt="avatar"></a></td>
...
<!-----------------------------booking----------------------------->
<section id="booking">
    <h3><u>WALL PAINTING PLANS</u></h3><br><hr>
    <div class="promos">  
        <div class="promo">
            <div class="deal">
                <span>Basic</span>
...
<div id="footer"><br>
    ...
    <div id="largebox1">
        <div id="box4">
            ...
            <b>  DecorArcade helps you hire the best professionals from designers to <br>
