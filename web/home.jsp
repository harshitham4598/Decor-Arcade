    ...
    <head>
        ...
        <style>
           <%---------------------------------header section------------------------------------%>
            body{
             ...
             header{
                background: linear-gradient(rgba(0,0,0,3),rgba(0,0,0,0)), url( "img/home.jpg");
                height:90vh;
      ...
      font-size: 30px;
        ...
        background: linear-gradient(to right,rgba(0,0,0,0),rgba(0,0,0,0));
            ...
            .xop-img-6{
                background: linear-gradient(rgba(0,0,0,0.0),rgba(0,0,0,1.10)),url("img/home10_1.jpg");
                              background-size: cover;
                 }
    ...
    <body>
        ...
        <div class="container" >
            <div class="one">
                <div class="content">
                    <h2> DREAM HOME!!</h2><br>
                    <p> Here we have a great site, <br>which helps you get your dream home!!!</p>    
                </div>
            </div>
            <div class="two">
                <div class="content">
            ...
            <ul class="xop-grid">
                <li>
                    <div class="xop-box xop-img-1">
                        ...
                        <a href="wallpainting.jsp"style="text-decoration:none;">
                            <h3>Wallpainting<br>Painting<br>Designing<br></h3>
                            </a>
                                                </div>
                    </div>                    
                </li>
                <li>
                    ...
                    <div class="xop-info">
                        ...
                        <a href="spaceplanning.jsp"style="text-decoration:none;">
                            <h3>Space <br>Planning<br>Designing<br></h3>
                            </a>
                    </div>
                    </div>                    
                </li>
                <li>
                    <div class="xop-box xop-img-3">
                        <div class="xop-info">
                        <a href="woodwork.jsp"style="text-decoration:none;">
                            <h3>WoodWork &<br> Furniture<br>Designing<br></h3>
                             </a>
                        </div>
                    </div>                    
                </li>
                <li>
                   ...
                   <div class="xop-info">
                        ...
                        <a href="flooring.jsp"style="text-decoration:none;">
                            <h3>Flooring <br>& Tiling<br>Designing<br></h3>
                           </a>
                   </div>
                    </div>                    
                </li>
                ...
                <li>
                    <div class="xop-box xop-img-5">
                        ...
                        <a href="interior.jsp"style="text-decoration:none;">
                            <h3>Decor/<br> Interior <br>Designing<br></h3>
                             </a>
                                                </div>
                    </div>                    
                </li>
                <li>
                    <div class="xop-box xop-img-6">
                        ...
                        <a href="all.jsp" style="text-decoration:none;">
                            <h3>ALL<br> Designings<br><br><br></h3>
                            </a>
                                                </div>
                    </div>                    
                </li>                                
...
<div class="mySlides fade">
 ...
 <div class="mySlides fade">
  ...
  <img src="img/slide8.jpg" style="width:100%">
             ...
             <div class="mySlides fade">
  <img src="img/slide9.jpg" style="width:100%">
</div> 
 <div class="mySlides fade">
  <img src="img/slide10.jpg" style="width:100%">
</div> 
</div>
<br>
