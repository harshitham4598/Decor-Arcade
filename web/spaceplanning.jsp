...
<html>
    <head>
        ...
        <title>Space Designing Page</title>
        <style>
            html,body{  
                margin: 0;
                padding: 0;
  ...
  background-color: #717171;
    ...
    <body>
        ...
        <div class="slideshow-container">
            <b><h1> <u>Space planing</u></h1></b>
<div class="mySlides fade">
  <img src="img/space0.jpg" style="width:80%;">

</div>

<div class="mySlides fade">

  <img src="img/space1.jpg" style="width:80%;">
</div>

<div class="mySlides fade">

  <img src="img/space2.jpg" style="width:80%">
</div>
...
<div id="contact"><br><br>
    ...
    <table align="center">
        <tr>
            ...
            <td><a href="https://instagram.com/manifest_building" target="null"><img src="img/instagram.png"alt="avatar"></a></td>
...
<!-----------------------------booking----------------------------->
<section id="booking">
    <h3><u>SPACE PLANNING PLANS</u></h3><br><hr>
    <div class="promos">  
        <div class="promo">
            <div class="deal">
                <span>Basic</span>
...
<div id="footer"><br>
    <div id="largebox">
        ...
        <div id="box2">
            ...
            <li><a href="index.jsp">FAQ'S</a></li>
    ...
    <div id="largebox1">
        ...
        <div id="box5">
            ...
            <table align="center">
                <tr>
                    <td> <a href="https://instagram.com/decor_arcade" target="null"><img src="img/instagram.png"alt="avatar"></td><td></td><td></td>
